...
function portal_migrations(PDO $pdo): void {
    ...
    try {
        ...
        $m=[
            ...
            29=>function($db){
                $db->exec("CREATE TABLE IF NOT EXISTS gamification_rules (
                    id INT AUTO_INCREMENT PRIMARY KEY,
                ...
                $db->exec("CREATE TABLE IF NOT EXISTS customer_point_wallets (
                ...
                $db->exec("CREATE TABLE IF NOT EXISTS customer_point_ledger (
                ...
                $db->exec("CREATE TABLE IF NOT EXISTS bonus_code_campaigns (
                    id INT AUTO_INCREMENT PRIMARY KEY,
                ...
                $db->exec("CREATE TABLE IF NOT EXISTS bonus_code_redemptions (
                    id BIGINT AUTO_INCREMENT PRIMARY KEY,
                ...
                $db->exec("CREATE TABLE IF NOT EXISTS reward_sites (
                    id INT AUTO_INCREMENT PRIMARY KEY,
                    name VARCHAR(150) NOT NULL,
                ...
                $db->exec("CREATE TABLE IF NOT EXISTS reward_catalog (
                    id INT AUTO_INCREMENT PRIMARY KEY,
                ...
                $db->exec("CREATE TABLE IF NOT EXISTS reward_coupon_pool (
                    id BIGINT AUTO_INCREMENT PRIMARY KEY,
                ...
                $db->exec("INSERT IGNORE INTO settings (setting_key, setting_value) VALUES ('module_gamification', '0'), ('gamification_store_message', 'کد تخفیف را هنگام خرید در سایت مقصد وارد کنید.')");
                $db->exec("INSERT IGNORE INTO admin_permissions (role, permission) VALUES ('admin', 'gamification')");
                $db->exec("INSERT IGNORE INTO gamification_rules (event_key, points, daily_cap, cooldown_seconds, is_active, description) VALUES

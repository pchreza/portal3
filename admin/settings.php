    ...
    if ($save_type === 'modules') {
        ...
        if ($logo_choice === 'upload') {
            ...
            if (!empty($_FILES['site_logo_file']['name']) && $_FILES['site_logo_file']['error'] === UPLOAD_ERR_OK) {
                ...
                $err = 'لطفاً یک فایل لوگو انتخاب کنید یا روش دیگری را برگزینید.';
            }
                    ...
                    <form method="POST" class="space-y-6" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="md:col-span-3">
                                ...
                                <input type="text" name="login_subtitle" value="<?= htmlspecialchars(login_subtitle_value()) ?>" class="w-full px-4 py-2.5 rounded-lg border border-slate-300 focus:ring-2 focus:ring-indigo-500 focus:outline-none text-sm">
                            </div>
                        </div>

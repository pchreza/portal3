# راهنمای نصب و ارتقای Portal3 v2.2.2
...
اجرای موفق باید schema را به نسخهٔ `31` برساند و در صورت وجود cache، تعداد cacheهای پاک‌شده را نیز در خروجی اعلام کند. migration را از browser یا با فعال‌کردن auto-migrate دائمی اجرا نکنید.
...
۲. از منوی «باشگاه امتیاز و پاداش» ruleهای امتیازدهی را تنظیم کنید. امتیاز مثبت هر rule آن را فعال و مقدار صفر آن را خاموش می‌کند؛ سپس سقف روزانه و cooldown را تعیین کنید. مواردی که مشتری قبلاً دریافت کرده، در داشبورد مشتری به‌صورت «قبلاً دریافت شده» نمایش داده می‌شوند.
